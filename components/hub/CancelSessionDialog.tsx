        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
          ...
          >
            ...
            <span className="min-w-0">
              <span className="text-[13.5px] font-bold text-foreground flex items-center gap-2 flex-wrap">
                Free — enough notice
                <span className="inline-flex items-center rounded-full px-2 py-0 text-[10.5px] font-extrabold uppercase tracking-wider bg-[var(--s-success-bg)] text-[var(--s-success)] border border-[var(--s-success-bd)]">
                  No session used
                </span>
              </span>
              <span className="text-xs text-muted-foreground mt-0.5 block">
            ...
            <div
              className={`rounded-xl p-4 border flex gap-3 ${
                chargedFree === "charged"
                  ...
                  : "bg-[var(--s-success-bg)] border-[var(--s-success-bd)]"
              }`}
            >
              <div className={`w-[30px] h-[30px] rounded-lg flex items-center justify-center shrink-0 bg-white/72 ${
                chargedFree === "charged" ? "text-[var(--status-danger)]" : "text-[var(--s-success)]"
              }`}>
              ...
              <div className="min-w-0">
                <p className="text-[13.5px] font-bold text-foreground leading-snug">
                  {chargedFree === "charged" ? (
                    ...
                    <>
                      This <em className="font-extrabold not-italic text-[var(--s-success)]">will not consume a session</em>.
                    </>
                  )}
                </p>
