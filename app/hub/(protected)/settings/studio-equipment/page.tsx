  ...
  return (
    <div>
      <HubPageHeader
        ...
        className="mb-5"
        actions={
          <span className="inline-flex items-center rounded-pill border px-2.5 py-1 text-xs font-semibold bg-[var(--status-success-bg)] text-[var(--status-success-text)] border-[var(--status-success-border)]">
            {activeCount} active
          </span>
        }
      />
