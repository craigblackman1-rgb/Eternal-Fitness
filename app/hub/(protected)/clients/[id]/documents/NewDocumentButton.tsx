...
const AVAILABLE_KINDS: DocumentKind[] = ["parq", "terms", "remote_coaching", "intake_form", "fortnightly_checkin", "risk_assessment", "annual_review", "consent", "feedback", "leg_pain_questionnaire"];
