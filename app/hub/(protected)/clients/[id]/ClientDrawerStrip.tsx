...
export function ClientDrawerStrip({ items }: { items: DrawerStripItem[] }) {
  ...
  return (
    <div className="flex items-center gap-1.5 flex-wrap p-[5px_8px] bg-white border border-[var(--hub-border)] rounded-[10px] mb-3.5 shadow-[0_1px_2px_rgba(16,24,40,.04),0_1px_3px_rgba(16,24,40,.07)]">
