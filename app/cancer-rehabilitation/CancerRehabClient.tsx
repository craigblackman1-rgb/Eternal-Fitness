...
export default function CancerRehabClient() {
  const stages = [
    { title: "During active treatment", body: "Chemotherapy and radiotherapy significantly affect energy, immune function, and physical capacity — and those effects are unpredictable from week to week. Sessions during active treatment are lower intensity, shorter, and built around your current treatment schedule. Every session begins with a check-in." },
    { title: "In remission", body: "Remission brings its own challenges — rebuilding fitness that has been lost, managing ongoing fatigue or side effects, and navigating the physical and emotional after-effects of treatment. Sessions progress gradually, respecting the timeline your body needs." },
    { title: "Post-surgery", body: "Whether mastectomy, colostomy, lymph node removal, or another procedure — post-surgical return to exercise requires careful, staged progression. I work within the guidance of your surgical team and will not progress any movement without appropriate medical clearance." },
  ];

  const considerations = [
    { title: "Cancer-related fatigue is different", body: "Cancer-related fatigue (CRF) does not respond to rest the way ordinary tiredness does. It is physiologically distinct — and training must account for it. I will never push through CRF or interpret it as effort avoidance." },
    { title: "Lymphoedema awareness", body: "For clients with or at risk of lymphoedema, I monitor for signs of swelling, avoid tight compression, and follow safe exercise guidelines. Exercise can actually help manage lymphoedema when programmed correctly." },
    { title: "Bone density", body: "Some cancer treatments (particularly certain hormonal therapies) accelerate bone density loss. Weight-bearing and resistance exercise is clinically recommended — but load and progression must be managed carefully." },
    { title: "GP or oncologist sign-off", body: "Before beginning any structured exercise programme during or shortly after treatment, I ask for GP or oncologist clearance. This is non-negotiable — not because I am being cautious, but because it is the right clinical standard." },
  ];

  const faqs = [
    { title: "Is it safe to exercise during cancer treatment?", body: "Evidence now strongly supports exercise during cancer treatment — at the right intensity and with the right guidance. The programme must account for your specific treatment, side effects, and current capacity. I will always ask for GP or oncologist sign-off before beginning." },
    { title: "What is cancer-related fatigue and how do you account for it?", body: "Cancer-related fatigue (CRF) is physiologically different from ordinary tiredness — it does not improve with rest in the same way. I am trained to recognise CRF and programme around it. Sessions may be shorter or lower in intensity on harder days. That is not failure — it is appropriate clinical management." },
    { title: "When can I start exercising after surgery?", body: "This depends entirely on the type of surgery and your recovery. I work with the guidance of your surgical team and will not progress any movement without appropriate medical clearance." },
    { title: "Do you work with people during active treatment?", body: "Yes. I work with people during active chemotherapy or radiotherapy, people in remission, and those who have finished treatment but are rebuilding. Each stage requires a different approach — the programme is built around where you are right now." },
  ];
    ...
    <div className="min-h-screen bg-background">
          ...
          <div>
            ...
            <Reveal y={24}>
              <p className="ds-body" style={{ marginTop: 20, marginBottom: 16 }}>
                {"Exercise during and after cancer treatment is no longer considered risky — the evidence now strongly supports it. Research shows that appropriate exercise during chemotherapy is associated with reduced fatigue, better mood, improved immune function, and faster recovery."}
              </p>
              <p className="ds-body" style={{ marginBottom: 16 }}>
                {"After treatment, structured exercise has been shown to improve overall survival rates in some cancer types, reduce the risk of recurrence, and significantly improve quality of life."}
              </p>
              <p className="ds-body" style={{ marginBottom: 28 }}>
                {"The qualifier is \u201Cappropriate.\u201D The intensity, type of exercise, and how it adapts to treatment side effects matters enormously — and that is where specialist training is essential."}
              </p>
              <Callout
                icon={IconRibbon}
                accent="rose"
      ...
      <Section background="white">
        <FaqSplit
          ...
          heading={"Common Questions About Cancer Rehabilitation"}
