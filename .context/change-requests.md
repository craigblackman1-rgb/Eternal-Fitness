...
untracked predecessor; CR-EF-016–027 built by Craig 2026-08-17 (hub/PWA
...
CR-EF-029–041 recovered 2026-08-18 — built 2026-08-17 on session
...
Status flow: built → approved → briefed → built → verified.
...
| CR-EF-034 | [BUG] Session naming inconsistent — `focus_label` ignored by client-detail tab (`Block n · Sn`) and session page; three independent archetype label maps; Outlook uses a fourth format | Bug | raised | 2026-08-17 | Assessment §1.4, fix H6 + §3.5 (one name, one label map). |
